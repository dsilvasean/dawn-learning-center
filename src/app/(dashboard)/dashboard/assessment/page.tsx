...
import { Cat, Dog, Fish, Rabbit, Turtle, ArrowBigLeft } from "lucide-react";
...
import {fetchChapters, fetchPatterns, fetchSubjects, fetchUserProfile} from '@/lib/api'
  ...
  return(
    <>
      <div className="relative overflow-hidden w-full">
        <div className="flex transition-transform duration-500" style={{transform:`translateX(-${(step-1) * 100}vw)`}}>
        ...
        <FormCard
          ...
          >
            <div className="grid gap-3">
              ...
              />
              <Label>Subject</Label>
              <Select value={selectedSubject?.name} onValueChange={(value)=>{
   ...
   <FormCard
          ...
          >
            <div className="grid gap-3">
              ...
              <Select value={selectedPaperFormat} onValueChange={(val)=>{
                setSelectedPaperFormat(val);
                const chapCount = paperFormat.find(format=>{
                  return format.description === val
                })
                setChapterCount(chapCount?.chapter_count);
